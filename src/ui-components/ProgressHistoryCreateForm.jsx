...
import { createProgressHistory } from "../graphql/mutations";
...
export default function ProgressHistoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSurahsRead(initialValues.surahsRead);
    setCurrentSurahsReadValue("");
    setAyahsRead(initialValues.ayahsRead);
    setJuzCompleted(initialValues.juzCompleted);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createProgressHistory.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ProgressHistoryCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
